...
<div class="my-4 list-group" id="download-list">
 <button type="button" class="list-group-item list-group-item-action active" disabled>Current (0.9.1)</button>
 <a class='list-group-item list-group-item-action' href='https://github.com/naev/naev/releases/download/v0.9.1/naev-0.9.1-win64.exe'>Windows 64-bit</a>
 <a class='list-group-item list-group-item-action' href='https://github.com/naev/naev/releases/download/v0.9.1/naev-0.9.1-macos.zip'>macOS 64-bit</a>
 <a class='list-group-item list-group-item-action' href='https://github.com/naev/naev/releases/download/v0.9.1/naev-0.9.1-linux-x86-64.AppImage'>Linux 64-bit AppImage</a>
 <a class='list-group-item list-group-item-action' href='https://github.com/naev/naev/releases/download/v0.9.1/naev-0.9.1-source.tar.gz'>Source Code</a>
</div>
