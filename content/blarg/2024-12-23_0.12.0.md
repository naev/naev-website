...
many engine improvements, such as 3D ships, an in-game wiki,
reworked weapon sets, notable performance increases, etc., but also a significant amount of new
content including a whole new area, more and reworked missions, and ship variants
among others. We also have not forgotten significant quality of life improvements;
folding messages, more visual indications for things such as important
characters at the spaceport bar, filtering for the mission computer, and more!
